...
<head>
    ...
    <script src="https://kit.fontawesome.com/496f482a46.js" crossorigin="anonymous"></script>
    ...
    <header class="bg-gray-dark sticky top-0 z-50">
        <div class="container mx-auto flex justify-between items-center py-4">
            ...
            <a href="/dashboard" class="flex items-center">
              <div>
                  <img src="{{asset('images/WearVibes.png')}}" alt="Logo" class="h-10 w-auto mr-4">
              </div>
            </a>
            ...
            <nav class="hidden lg:flex md:flex-grow justify-center">
              <ul class="flex justify-center space-x-4 text-white">
                  ...
                  <li class="relative group" x-data="{ open: false }">
                      <a href="/Mens" @mouseover="open = true" @mouseleave="open = false" href="#" class="hover:text-secondary font-semibold flex items-center">
                          Men
                      ...
                      >
                          <li><a href="/Mens" class="min-w-40 block px-4 py-2 hover:bg-primary hover:text-white rounded">Men Item 1</a></li>
                          <li><a href="/Mens" class="min-w-40 block px-4 py-2 hover:bg-primary hover:text-white rounded">Men Item 2</a></li>
                          <li><a href="/Mens" class="min-w-40 block px-4 py-2 hover:bg-primary hover:text-white rounded">Men Item 3</a></li>
                      </ul>
                  </li>
                  ...
                  <li class="relative group" x-data="{ open: false }">
                      ...
                      <ul
                          ...
                          x-transition:leave-end="opacity-0 scale-90"
                      >
                          <li><a href="/Mens" class="min-w-40 block px-4 py-2 hover:bg-primary hover:text-white rounded">Women Item 1</a></li>
                          <li><a href="/Mens" class="min-w-40 block px-4 py-2 hover:bg-primary hover:text-white rounded">Women Item 2</a></li>
                          <li><a href="/Mens" class="min-w-40 block px-4 py-2 hover:bg-primary hover:text-white rounded">Women Item 3</a></li>
                      </ul>
                  </li>

                  <li><a href="/Mens" class="hover:text-secondary font-semibold">Shop</a></li>
                  {{-- <li><a href="/product" class="hover:text-secondary font-semibold">Product</a></li> --}}
                  {{-- <li><a href="/404" class="hover:text-secondary font-semibold">404 page</a></li> --}}
                  <li><a href="/check-out" class="hover:text-secondary font-semibold">Checkout</a></li>
              </ul>
            </nav>
            ...
            <div class="hidden lg:flex items-center space-x-4 relative">
              ...
              <div class="relative flex gap-4 group cart-wrapper">
                  <a href="/Cart" >
                      <img src="{{asset('images/cart-shopping.svg')}}" alt="Cart" class="h-6 w-6 group-hover:scale-110">
                  </a>
                  <!-- Cart dropdown -->
                  <div class="absolute right-5 top-6 mt-4 w-80 bg-white shadow-lg p-4 rounded hidden group-hover:block">
                      <div class="space-y-4">
                          <!-- product item -->
                          @if(Session::has('cart'))
                          ...
                          <div class="flex items-center justify-between pb-4 border-b border-gray-line">
                              <div class="flex items-center">
                                  <img src="{{$main_img}}" alt="Product" class="h-12 w-12 object-cover rounded mr-2">
                                  <div>
                                      <p class="font-semibold">{{$product->name}}</p>
                                      <p class="text-sm">Quantity: {{$cart_item['qty']}}</p>
                                  </div>
                              </div>
                              <p class="font-semibold">${{ number_format( $cart_item['qty'] * $product->discounted_price, 2) }}</p>
                          </div>                          
                      @endforeach
                      @endif
      ...
      <ul class="w-full">
          ...
          <li class="relative group" x-data="{ open: false }">
              ...
              <ul class="mobile-dropdown-menu" x-show="open" x-transition class="space-y-2">
                  <li><a href="/Mens" class="hover:text-secondary font-bold block pt-2 pb-3">Shop Men</a></li>
                  <li><a href="/product" class="hover:text-secondary font-bold block py-2">Men item 1</a></li>
                  <li><a href="/product" class="hover:text-secondary font-bold block py-2">Men item 2</a></li>
                  <li><a href="/product" class="hover:text-secondary font-bold block py-2">Men item 3</a></li>
              </ul>
          </li>
          ...
          <li class="relative group" x-data="{ open: false }">
              ...
              <ul class="mobile-dropdown-menu" x-show="open" x-transition class="pl-4 space-y-2">
                  <li><a href="/Mens" class="hover:text-secondary font-bold block py-2">Shop Women</a></li>
                  <li><a href="/product" class="hover:text-secondary font-bold block py-2">Women item 1</a></li>
                  <li><a href="/product" class="hover:text-secondary font-bold block py-2">Women item 2</a></li>
                  <li><a href="/product" class="hover:text-secondary font-bold block py-2">Women item 3</a></li>
              </ul>
          </li>

          <li><a href="/Mens" class="hover:text-secondary font-bold block py-2">Shop</a></li>
          {{-- <li><a href="/product" class="hover:text-secondary font-bold block py-2">Product</a></li>
          <li><a href="/404" class="hover:text-secondary font-bold block py-2">404 page</a></li> --}}
          <li><a href="/check-out" class="hover:text-secondary font-bold block py-2">Checkout</a></li>
      </ul>
        ...
        <div class="container mx-auto px-4 py-10">
          <div class="flex flex-wrap -mx-4">
            ...
            <div class="w-full sm:w-1/6 px-4 mb-8">
              ...
              <ul>
                <li><a href="/Mens" class="hover:text-primary">Shop</a></li>
                <li><a href="/product" class="hover:text-primary">Women</a></li>
                <li><a href="/Mens" class="hover:text-primary">Men</a></li>
                <li><a href="/product" class="hover:text-primary">Shoes</a></li>
                <li><a href="/product" class="hover:text-primary">Accessories</a></li>
              </ul>
            </div>
            <!-- Menu 2 -->
            <div class="w-full sm:w-1/6 px-4 mb-8">
              ...
              <ul>
                <li><a href="/Mens" class="hover:text-primary">Shop</a></li>
                <li><a href="/product" class="hover:text-primary">Product</a></li>
                <li><a href="/check-out" class="hover:text-primary">Checkout</a></li>
                <li><a href="/404" class="hover:text-primary">404</a></li>
              </ul>
            </div>
            <!-- Menu 3 -->
            <div class="w-full sm:w-1/6 px-4 mb-8">
            ...
            <div class="w-full sm:w-2/6 px-4 mb-8">
              ...
              <p><img src="{{asset('images/WearVibes white.png')}}" alt="Logo" class="h-[60px] mb-4"></p>
              <p>123 Street Name, Paris, France</p>
              <p class="text-xl font-bold my-4" tel: +91 9087654321>Phone: +91 9087654321</p>
              <a href="mailto:info@wearvibes.com" class="underline">Email: info@wearvibes.com</a>
            </div>
          </div>
        </div>
        ...
        <div class="py-6 border-t border-gray-line">
          <div class="container mx-auto px-4 flex flex-wrap justify-between items-center">
            ...
            <div class="w-full lg:w-3/4 text-center lg:text-left mb-4 lg:mb-0">
              <p class="mb-2 font-bold">&copy; 2025 Your Company. All rights reserved.</p>
