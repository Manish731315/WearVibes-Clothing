...
@php
	$product = App\Models\productTable::where('status',1)->find($id);
        $main_img = '';
                    ...
                    <div class="w-full lg:w-1/2 flex flex-col justify-between">
                        <div class="pb-8 border-b border-gray-line">
                            ...
                            <div class="flex items-center mb-8">
                                <span>
                                    @for($i = $product->review; $i >= 1; $i--)
                                    <i class="fa-solid fa-star"></i>
                                    @endfor
                                    @for($i = (5 - $product->review); $i >= 1; $i--)
                            ...
                            <div class="mb-4 pb-4 border-b border-gray-line">
                                <p class="mb-2">Brand:<strong><a href="#" class="hover:text-primary"> {{$product->brand}}</a></strong>
                                </p>
                                <p class="mb-2">Product code:<strong> {{$product->product_code}}</strong></p>
                                <p class="mb-2">Availability:<strong> 
                                    {{$product->availability == 1 ? 'In Stock' : 'Out of stock'}}
                                </strong></p>
                            </div>
                            <div class="text-2xl font-semibold mb-8">${{number_format($product->discounted_price, 2)}}</div>
                            <div class="flex items-center mb-8">
                                <button id="decrease"
                                    ...
                                    disabled>-</button>
                                <input id="quantity" type="number" max="{{$product->stock}}" min="1"
                                 value="1"
                            ...
                            <button
                                onclick="
                                    ...
                                    window.location.href = '/add-to-cart?p_id={{$product->id}}&qty='+qty;
                                "
                                class="bg-primary border border-transparent hover:bg-transparent hover:border-primary text-white hover:text-primary font-semibold py-2 px-4 rounded-full">Add to Cart
                            </button>
                        </div>
                        <!-- Social sharing -->
            ...
            <div class="flex flex-wrap -mx-4">
                ...
                <div class="w-full sm:w-1/2 lg:w-1/4 px-4 mb-8">
                  <div class="bg-white p-3 rounded-lg shadow-lg">
                    <img src="/images/products/5.jpg" alt="Product 1" class="w-full object-cover mb-4 rounded-lg">
                ...
                <div class="w-full sm:w-1/2 lg:w-1/4 px-4 mb-8">
                  <div class="bg-white p-3 rounded-lg shadow-lg">
                    <img src="/images/products/6.jpg" alt="Product 2" class="w-full object-cover mb-4 rounded-lg">
                ...
                <div class="w-full sm:w-1/2 lg:w-1/4 px-4 mb-8">
                  <div class="bg-white p-3 rounded-lg shadow-lg">
                    <img src="/images/products/7.jpg" alt="Product 3" class="w-full object-cover mb-4 rounded-lg">
                ...
                <div class="w-full sm:w-1/2 lg:w-1/4 px-4 mb-8">
                  <div class="bg-white p-3 rounded-lg shadow-lg">
                    <img src="/images/products/8.jpg" alt="Product 4" class="w-full object-cover mb-4 rounded-lg">
